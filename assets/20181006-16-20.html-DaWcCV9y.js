import{_ as s}from"./wechatpublic-DwVcFg7_.js";import{_ as a}from"./plugin-vue_export-helper-DlAUqK2U.js";import{r as e,o as t,c as i,b as p,e as c}from"./app-DZF5azVq.js";const o="/assets/16-DqLgcuMQ.webp",l="/assets/17-QTwersHU.webp",r="/assets/18-8peGsDvK.webp",u="/assets/20190306220952858-CQUyTGs6.webp",d="/assets/20190306221430823-B-bWXqwt.webp",m={},k=c(`<h1 id="python3-编程实例-16-20" tabindex="-1"><a class="header-anchor" href="#python3-编程实例-16-20" aria-hidden="true">#</a> Python3 编程实例（16 - 20）</h1><div class="hint-container info"><p class="hint-container-title">共勉</p><p>不要哀求，学会争取。若是如此，终有所获。</p></div><h2 id="实例16" tabindex="-1"><a class="header-anchor" href="#实例16" aria-hidden="true">#</a> 实例16</h2><h3 id="题目" tabindex="-1"><a class="header-anchor" href="#题目" aria-hidden="true">#</a> 题目</h3><p>输出指定格式的日期；</p><h3 id="分析" tabindex="-1"><a class="header-anchor" href="#分析" aria-hidden="true">#</a> 分析</h3><p>没啥说的，直接调用 <code>datetime</code> 模块即可；</p><h3 id="代码" tabindex="-1"><a class="header-anchor" href="#代码" aria-hidden="true">#</a> 代码</h3><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token comment">#!/usr/bin/env python</span>
